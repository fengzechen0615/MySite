                ...
                <div className='row'>
                    ...
                    <div className='col-sm-4 col-md-4 text-center'>
                        <div className='personal-website-project'>
                            ...
                            <p>
                                ...
                                provided an outlet to showcase my abilities and
                                interests.
                            </p>
                            <div className='row'>
                                <div className='col-sm-4 col-md-4 col-sm-offset-4 col-md-offset-4'>
                    ...
                    <div className='col-sm-4 col-md-4 text-center'>
                        <div className='strike-zone-project'>
                            ...
                            <p>
                                Data analytics project completed during my time
                                at the Illinois Math and Science Academy which
                                studied the baseball strike zone based on the
                                state of the game.
                            </p>
                            <div className='row'>
                                <div className='col-sm-4 col-md-4 col-sm-offset-4 col-md-offset-4'>
